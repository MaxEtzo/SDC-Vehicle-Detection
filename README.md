...
* HOG: **10 orientations**, **16x16 pixels per cell**, **1x1 cells per block** for each color channel
...
* color histogram range depends on color space. For colorspaces 'HSV' and 'HLS' the range is between 0 and 180 for Hue channel.
* uint8 format is assumed (0 to 255 range)
